...
namespace Cofefe.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            // ѕолучаем текущего пользовател€ из сессии
            int? userId = HttpContext.Session.GetInt32("UserId");
            if (userId == null)
            {
                // ≈сли пользователь не аутентифицирован, возвращаем ошибку или перенаправл€ем на страницу входа
                return RedirectToAction("Login");
            }

                // ”дал€ем продукт из избранного, если он там есть
